              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    cell handles content that exceeds the available space. We
                    want to see how text wrapping and overflow handling work
                    with this CSS configuration.
                  </td>
                  <td>Electronics</td>
                  <td>Available</td>
                  <td>2023-05-15</td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    specifications and detailed information about the product
                    features and benefits to customers looking for specific
                    solutions.
                  </td>
                  <td>Home & Garden</td>
                  <td>Out of Stock</td>
                ...
                <tr>
                  <td>004</td>
                  <td>
                    Medium length description with some details about the item
                    that provides context but isn't excessively long.
                  </td>
                  <td>Books</td>
                  <td>Pre-order</td>
                  <td>2023-08-05</td>
