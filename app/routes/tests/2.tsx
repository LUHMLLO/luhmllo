    ...
    <div id="top">
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                <a href="#forms__output">Output element</a>
              </li>
              <li>
          ...
          <li>
            ...
            <ul>
              <li>
                <a href="#interactive__details">Details/Summary</a>
              </li>
              <li>
          ...
          <li>
            <a href="#sectioning">Sectioning elements</a>
            <ul>
              <li>
              ...
              <li>
                <a href="#sectioning__headers">Multiple headers</a>
              </li>
              <li>
                <a href="#sectioning__footers">Multiple footers</a>
              </li>
            </ul>
          </li>
          <li>
            <a href="#template">Template & Web Components</a>
            <ul>
              <li>
          ...
          <li>
            <a href="#legacy">Legacy elements</a>
            <ul>
              <li>
      ...
      <main>
        <section id="text">
          ...
          <article id="text__paragraphs">
            ...
            <div>
              ...
              <p>
                ...
                word<wbr />break<wbr />opportunity to test the wbr tag in a long
                word like supercalifragilistic<wbr />expialidocious.
              </p>
            </div>
            <footer>
              <p>
          ...
          <article id="text__address">
            ...
            <address>
              ...
              <a href="mailto:webmaster@example.com">
                contact webmaster
              </a>.<br />You may also want to visit us:<br />Mozilla
              Foundation<br />331 E Evelyn Ave<br />Mountain View, CA
              94041<br />USA
            </address>
            <footer>
              <p>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Table Cell 2</td>
                  <td>Table Cell 3</td>
                  <td rowSpan={2}>Table Cell with rowspan</td>
                  <td>Table Cell 5</td>
                </tr>
                <tr>
                  <td>Table Cell 1</td>
                  <td colSpan={2}>Table Cell with colspan</td>
                  <td>Table Cell 5</td>
                </tr>
                <tr>
                  <td>Table Cell 1</td>
          ...
          <article id="text__ruby">
            ...
            <div>
              <p>
                ...
                - The Japanese word for Kanji (漢字)
              </p>
            </div>
            <footer>
              <p>
          ...
          <article id="text__bidirectional">
            <header>
              <h2>Bidirectional Text</h2>
            </header>
            <div>
              <p>
                <bdi>This text will go left-to-right</bdi>
              </p>
              <p>
                <bdi>هذا النص سيذهب من اليمين إلى اليسار</bdi>{" "}
          ...
          <article id="text__legacy">
            ...
            <div>
              ...
              <p>
                <center>This text is centered with the center tag</center>
              </p>
              <p>
                <big>This text is big</big> and{" "}
                <small>this text is small</small>
              </p>
              <p>
                <strike>
                  This text has a strikethrough with the strike tag
                </strike>
              </p>
              <p>
        ...
        <section id="embedded">
          ...
          <article id="embedded__image_maps">
            <header>
              <h2>Image Maps</h2>
            </header>
            <div>
