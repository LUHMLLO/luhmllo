...
<header
  data-is='stack'
  data-layout='expand'
  style='background-color: var(--clr-background__base); gap: var(--md); padding-block: 128px; place-content: center;'>
  ...
  <h1>Lilycat</h1>
    A minimal, attribute-driven CSS library built for developers and designers who
    value clarity, speed, and control — without the hassle of steep learning
  ...
  <ul>
    ...
    <li><a href='/drafts'>Made with -Drafts</a></li>
    <li><a href='/projects'>Real World Projects</a></li>
  </ul>
</header>
