...
`;var it=Object.defineProperty,rt=Object.getOwnPropertyDescriptor,me=(t,e,s,i)=>{for(var r,n=i>1?void 0:i?rt(e,s):e,o=t.length-1;o>=0;o--)(r=t[o])&&(n=(i?r(e,s,n):r(n))||n);return i&&n&&it(e,s,n),n};let L=class extends u{constructor(){super(...arguments),this.solid=!1}async connectedCallback(){super.connectedCallback()}async disconnectedCallback(){super.disconnectedCallback()}render(){return f` <slot></slot> `}};L.styles=st,me([I({type:Boolean,reflect:!0})],L.prototype,"solid",2),L=me([C("ly-icon")],L);const nt=w`
	@layer web-components {
		:host {
			/* base styles */
			cursor: pointer;
