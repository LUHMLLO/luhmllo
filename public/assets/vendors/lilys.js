...
`;var vt=Object.defineProperty,bt=Object.getOwnPropertyDescriptor,E=(e,t,s,r)=>{for(var i,o=r>1?void 0:r?bt(t,s):t,n=e.length-1;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&vt(t,s,o),o},je=(e=>(e[e.debug=0]="debug",e[e.error=1]="error",e[e.info=2]="info",e[e.success=3]="success",e[e.warning=4]="warning",e))(je||{});let m=class extends p{constructor(){super(...arguments),this.label="",this.caption="",this.name="",this.required=!1,this.status="",this.type="text"}async connectedCallback(){super.connectedCallback()}firstUpdated(){var e;const t=null==(e=this.renderRoot)?void 0:e.querySelector("slot");let s=null==t?void 0:t.assignedElements();s&&s.forEach((e=>{e.setAttribute("name",this.name),e.setAttribute("title",this.name),e.setAttribute("type",this.type)}))}async disconnectedCallback(){super.disconnectedCallback()}render(){return c`
			...
			${this.caption?c`
				  ...
				  `:d}
		`}setRequiredIcon(){return this.required?c`<ly-icon part="required-icon">asterisk</ly-icon>`:c``}setStatusIcon(){switch(this.status){case"debug":return c`<ly-icon>bug_report</ly-icon>`;case"error":return c`<ly-icon>report</ly-icon>`;case"info":return c`<ly-icon>info</ly-icon>`;case"success":return c`<ly-icon>check</ly-icon>`;case"warning":return c`<ly-icon>emergency_home</ly-icon>`;default:return c``}}};m.styles=ft,E([v({type:String,reflect:!0})],m.prototype,"label",2),E([v({type:String,reflect:!0})],m.prototype,"caption",2),E([v({type:String,reflect:!0})],m.prototype,"name",2),E([v({type:Boolean,reflect:!0})],m.prototype,"required",2),E([v({type:je,reflect:!0})],m.prototype,"status",2),E([v({type:String,reflect:!0})],m.prototype,"type",2),m=E([y("ly-field")],m);const gt=b`
	@layer web-components {
		:host(:is(ly-grid)) {
			/* local vars */
			--cols: 1;
...
`;var mt=Object.defineProperty,$t=Object.getOwnPropertyDescriptor,_t=(e,t,s,r)=>{for(var i,o=r>1?void 0:r?$t(t,s):t,n=e.length-1;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&mt(t,s,o),o};let re=class extends p{async connectedCallback(){super.connectedCallback()}async disconnectedCallback(){super.disconnectedCallback()}render(){return c` <slot></slot> `}};re.styles=gt,re=_t([y("ly-grid")],re);const xt=b`
	@layer web-components {
		:host(:is(ly-group)) {
			/* base styles */
			display: flex;
...
`;var Et=Object.defineProperty,kt=Object.getOwnPropertyDescriptor,Re=(e,t,s,r)=>{for(var i,o=r>1?void 0:r?kt(t,s):t,n=e.length-1;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&Et(t,s,o),o};let G=class extends p{constructor(){super(...arguments),this.solid=!1}async connectedCallback(){super.connectedCallback()}async disconnectedCallback(){super.disconnectedCallback()}render(){return c` <slot></slot> `}};G.styles=Pt,Re([v({type:Boolean,reflect:!0})],G.prototype,"solid",2),G=Re([y("ly-icon")],G);const St=b`
	@layer web-components {
		:host(:is(ly-layer)) {
			/* local vars */
			--bg: transparent;
