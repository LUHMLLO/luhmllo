...
`;var gs=Object.defineProperty,ys=Object.getOwnPropertyDescriptor,Re=(t,e,n,s)=>{for(var r,i=s>1?void 0:s?ys(e,n):e,o=t.length-1;o>=0;o--)(r=t[o])&&(i=(s?r(e,n,i):r(i))||i);return s&&i&&gs(e,n,i),i};let At=class extends _{constructor(){super(...arguments),this.layout="default"}render(){return y` <slot></slot> `}};At.styles=ms,Re([E({type:String,reflect:!0})],At.prototype,"layout",2),At=Re([S("ly-app")],At);const vs=R`
	@layer web-components {
		:host(:is(ly-icon)) {
			/* base styles */
			aspect-ratio: 1/1;
...
`;var pn=Object.defineProperty,fn=Object.getOwnPropertyDescriptor,V=(t,e,n,s)=>{for(var r,i=s>1?void 0:s?fn(e,n):e,o=t.length-1;o>=0;o--)(r=t[o])&&(i=(s?r(e,n,i):r(i))||i);return s&&i&&pn(e,n,i),i};let H=class extends _{constructor(){super(...arguments),this.label="",this.caption="",this.name="",this.ref="",this.required=!1,this.status="",this.type="text"}async connectedCallback(){super.connectedCallback()}updated(){var t;const e=null==(t=this.renderRoot)?void 0:t.querySelector("slot");let n=null==e?void 0:e.assignedElements();n&&n.forEach((t=>{(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement)&&(this.ref&&t.setAttribute("id",this.ref),this.name&&t.setAttribute("name",this.name),this.required&&t.setAttribute("required",`${this.required}`),this.type&&t.setAttribute("type",this.type))}))}async disconnectedCallback(){super.disconnectedCallback()}render(){return y`
			${this.label?y`
			...
			${this.caption?y`
				  ...
				  `:$}
		`}setRequiredIcon(){return this.required?y`<ly-icon part="required-icon">asterisk</ly-icon>`:y``}setStatusIcon(){switch(this.status){case"debug":return y`<ly-icon part="caption-icon">bug_report</ly-icon>`;case"error":return y`<ly-icon part="caption-icon">report</ly-icon>`;case"info":return y`<ly-icon part="caption-icon">info</ly-icon>`;case"success":return y`<ly-icon part="caption-icon">check</ly-icon>`;case"warning":return y`<ly-icon part="caption-icon">emergency_home</ly-icon>`;default:return y``}}};H.styles=un,V([E({type:String})],H.prototype,"label",2),V([E({type:String})],H.prototype,"caption",2),V([E({type:String})],H.prototype,"name",2),V([E({type:String})],H.prototype,"ref",2),V([E({type:Boolean,reflect:!0})],H.prototype,"required",2),V([E({type:"debug"})],H.prototype,"status",2),V([E({type:String})],H.prototype,"type",2),H=V([S("ly-field")],H);var mn=Object.defineProperty,gn=Object.getOwnPropertyDescriptor,yn=(t,e,n,s)=>{for(var r,i=s>1?void 0:s?gn(e,n):e,o=t.length-1;o>=0;o--)(r=t[o])&&(i=(s?r(e,n,i):r(i))||i);return s&&i&&mn(e,n,i),i};let zt=class extends _{render(){return y` <slot></slot> `}};zt.styles=R`
		:host {
			display: contents;
		}
	`,zt=yn([S("ly-fragment")],zt);const vn=R`
	@layer web-components {
		:host(:is(ly-layer)) {
			/* local vars */
			--bg: none;
...
`;var xn=Object.defineProperty,wn=Object.getOwnPropertyDescriptor,ze=(t,e,n,s)=>{for(var r,i=s>1?void 0:s?wn(e,n):e,o=t.length-1;o>=0;o--)(r=t[o])&&(i=(s?r(e,n,i):r(i))||i);return s&&i&&xn(e,n,i),i};let Ct=class extends _{constructor(){super(...arguments),this.stacked="over"}render(){return y` <slot></slot> `}};Ct.styles=vn,ze([E({type:String,reflect:!0})],Ct.prototype,"stacked",2),Ct=ze([S("ly-layer")],Ct);var ne=(t=>(t[t.col=0]="col",t[t.row=1]="row",t))(ne||{});const bn=R`
	@layer web-components {
		:host(:is(ly-flex)) {
			/* base styles */
			display: flex;
...
`;var Sn=Object.defineProperty,On=Object.getOwnPropertyDescriptor,xt=(t,e,n,s)=>{for(var r,i=s>1?void 0:s?On(e,n):e,o=t.length-1;o>=0;o--)(r=t[o])&&(i=(s?r(e,n,i):r(i))||i);return s&&i&&Sn(e,n,i),i};let Vt=class extends _{async connectedCallback(){super.connectedCallback()}async disconnectedCallback(){super.disconnectedCallback()}render(){return y` <slot></slot> `}};Vt.styles=vt,Vt=xt([S("ly-list")],Vt);let qt=class extends _{render(){return y` <slot></slot> `}};qt.styles=vt,qt=xt([S("ly-list-header")],qt);let Gt=class extends _{render(){return y` <slot></slot> `}};Gt.styles=vt,Gt=xt([S("ly-list-row")],Gt);let Xt=class extends _{render(){return y` <slot></slot> `}};Xt.styles=vt,Xt=xt([S("ly-list-footer")],Xt);let Yt=class extends _{render(){return y` <slot></slot> `}};Yt.styles=vt,Yt=xt([S("ly-list-cell")],Yt);const Cn=R`
	@layer web-components {
		:host(:is(ly-slider)) {
			/* local vars */
			--bg: none;
