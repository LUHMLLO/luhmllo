...
`;var at=Object.defineProperty,ht=Object.getOwnPropertyDescriptor,ye=(e,t,s,r)=>{for(var i,o=r>1?void 0:r?ht(t,s):t,n=e.length-1;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&at(t,s,o),o};let U=class extends p{constructor(){super(...arguments),this.checked=!1,this.label=""}toggleChecked(){this.checked=!this.checked,this.dispatchEvent(new CustomEvent("change",{bubbles:!0,detail:{checked:this.checked}}))}async connectedCallback(){super.connectedCallback(),this.setAttribute("tabindex","0"),this.addEventListener("focus",(()=>this.focus())),this.addEventListener("click",(()=>this.toggleChecked()))}async disconnectedCallback(){super.disconnectedCallback(),this.removeAttribute("tabindex"),this.removeEventListener("focus",(()=>this.focus())),this.removeEventListener("click",(()=>this.toggleChecked()))}render(){return c`
			<ly-row part="row">
				...
				${this.label?c`<label part="label">${this.label}</label>`:h}
			</ly-row>
			${this.checked?c`<slot></slot>`:h}
...
`;var vt=Object.defineProperty,bt=Object.getOwnPropertyDescriptor,E=(e,t,s,r)=>{for(var i,o=r>1?void 0:r?bt(t,s):t,n=e.length-1;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&vt(t,s,o),o},je=(e=>(e[e.debug=0]="debug",e[e.error=1]="error",e[e.info=2]="info",e[e.success=3]="success",e[e.warning=4]="warning",e))(je||{});let $=class extends p{constructor(){super(...arguments),this.label="",this.caption="",this.name="",this.required=!1,this.status="",this.type="text"}async connectedCallback(){super.connectedCallback();let e=this.querySelector("input");e&&(e.name=this.name,e.title=this.name,e.type=this.type)}async disconnectedCallback(){super.disconnectedCallback()}render(){return c`
			${this.label?c`
						<label for=${this.name} part="label">
							${this.label}
							${this.required?c`<ly-icon part="required-icon">asterisk</ly-icon>`:h}
						</label>
				  `:h}
			...
			${this.caption?c`
				  ...
				  `:h}
		`}setStatusIcon(){switch(this.status){case"debug":return c`<ly-icon>bug_report</ly-icon>`;case"error":return c`<ly-icon>report</ly-icon>`;case"info":return c`<ly-icon>info</ly-icon>`;case"success":return c`<ly-icon>check</ly-icon>`;case"warning":return c`<ly-icon>emergency_home</ly-icon>`;default:return c``}}};$.styles=ft,E([v({type:String,reflect:!0})],$.prototype,"label",2),E([v({type:String,reflect:!0})],$.prototype,"caption",2),E([v({type:String,reflect:!0})],$.prototype,"name",2),E([v({type:Boolean,reflect:!0})],$.prototype,"required",2),E([v({type:je,reflect:!0})],$.prototype,"status",2),E([v({type:String,reflect:!0})],$.prototype,"type",2),$=E([y("ly-field")],$);const gt=b`
	@layer web-components {
		:host(:is(ly-grid)) {
			/* local vars */
			--cols: 1;
...
`;var It=Object.defineProperty,qt=Object.getOwnPropertyDescriptor,He=(e,t,s,r)=>{for(var i,o=r>1?void 0:r?qt(t,s):t,n=e.length-1;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&It(t,s,o),o};let K=class extends p{constructor(){super(...arguments),this.direction="row"}async connectedCallback(){super.connectedCallback()}async disconnectedCallback(){super.disconnectedCallback()}render(){return c` <slot></slot> `}};K.styles=Bt,He([v({type:String,reflect:!0})],K.prototype,"direction",2),K=He([y("ly-slider")],K);const Wt=b`
	@layer web-components {
		:host(:is(ly-switch)) {
			/* base styles */
			cursor: pointer;
...
`;var Ft=Object.defineProperty,Vt=Object.getOwnPropertyDescriptor,Re=(e,t,s,r)=>{for(var i,o=r>1?void 0:r?Vt(t,s):t,n=e.length-1;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&Ft(t,s,o),o};let M=class extends p{constructor(){super(...arguments),this.checked=!1}toggleChecked(){this.checked=!this.checked,this.dispatchEvent(new CustomEvent("change",{bubbles:!0,detail:{checked:this.checked}}))}async connectedCallback(){super.connectedCallback(),this.setAttribute("tabindex","0"),this.addEventListener("focus",(()=>this.focus())),this.addEventListener("click",(()=>this.toggleChecked()))}async disconnectedCallback(){super.disconnectedCallback(),this.removeAttribute("tabindex"),this.removeEventListener("focus",(()=>this.focus())),this.removeEventListener("click",(()=>this.toggleChecked()))}render(){return c`
			<ly-icon ?solid="${this.checked}">
				${this.checked?"toggle_on":"toggle_off"}
			</ly-icon>
		`}};M.properties={delegatesFocus:{type:Boolean,reflect:!0}},M.styles=Wt,Re([v({type:Boolean,reflect:!0})],M.prototype,"checked",2),M=Re([y("ly-switch")],M);export{V as App,U as Checkbox,se as Col,$ as Field,re as Grid,ie as Group,G as Icon,J as Layer,oe as List,ae as ListCell,ce as ListFooter,ne as ListHeader,le as ListRow,P as Radio,he as Row,K as Slider,M as Switch};