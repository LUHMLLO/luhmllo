 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const H=globalThis,W=H.trustedTypes,ve=W?W.createPolicy("lit-html",{createHTML:t=>t}):void 0,Ee="$lit$",b=`lit$${(Math.random()+"").slice(9)}$`,Pe="?"+b,Je=`<${Pe}>`,E=document,M=()=>E.createComment(""),N=t=>null===t||"object"!=typeof t&&"function"!=typeof t,Ce=Array.isArray,Ke=t=>Ce(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]),ee="[ \t\n\f\r]",R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,$e=/-->/g,_e=/>/g,A=RegExp(`>|${ee}(?:([^\\s"'>=/]+)(${ee}*=${ee}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),be=/'/g,xe=/"/g,Oe=/^(?:script|style|textarea|title)$/i,Ve=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),a=Ve(1),U=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),we=new WeakMap,S=E.createTreeWalker(E,129);function Ue(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==ve?ve.createHTML(e):e}const Ze=(t,e)=>{const s=t.length-1,r=[];let i,o=2===e?"<svg>":"",l=R;for(let e=0;e<s;e++){const s=t[e];let n,a,c=-1,h=0;for(;h<s.length&&(l.lastIndex=h,a=l.exec(s),null!==a);)h=l.lastIndex,l===R?"!--"===a[1]?l=$e:void 0!==a[1]?l=_e:void 0!==a[2]?(Oe.test(a[2])&&(i=RegExp("</"+a[2],"g")),l=A):void 0!==a[3]&&(l=A):l===A?">"===a[0]?(l=i??R,c=-1):void 0===a[1]?c=-2:(c=l.lastIndex-a[2].length,n=a[1],l=void 0===a[3]?A:'"'===a[3]?xe:be):l===xe||l===be?l=A:l===$e||l===_e?l=R:(l=A,i=void 0);const d=l===A&&t[e+1].startsWith("/>")?" ":"";o+=l===R?s+Je:c>=0?(r.push(n),s.slice(0,c)+Ee+s.slice(c)+b+d):s+b+(-2===c?e:d)}return[Ue(t,o+(t[s]||"<?>")+(2===e?"</svg>":"")),r]};class D{constructor({strings:t,_$litType$:e},s){let r;this.parts=[];let i=0,o=0;const l=t.length-1,n=this.parts,[a,c]=Ze(t,e);if(this.el=D.createElement(a,s),S.currentNode=this.el.content,2===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(r=S.nextNode())&&n.length<l;){if(1===r.nodeType){if(r.hasAttributes())for(const t of r.getAttributeNames())if(t.endsWith(Ee)){const e=c[o++],s=r.getAttribute(t).split(b),l=/([.?@])?(.*)/.exec(e);n.push({type:1,index:i,name:l[2],strings:s,ctor:"."===l[1]?Xe:"?"===l[1]?Ye:"@"===l[1]?et:Q}),r.removeAttribute(t)}else t.startsWith(b)&&(n.push({type:6,index:i}),r.removeAttribute(t));if(Oe.test(r.tagName)){const t=r.textContent.split(b),e=t.length-1;if(e>0){r.textContent=W?W.emptyScript:"";for(let s=0;s<e;s++)r.append(t[s],M()),S.nextNode(),n.push({type:2,index:++i});r.append(t[e],M())}}}else if(8===r.nodeType)if(r.data===Pe)n.push({type:2,index:i});else{let t=-1;for(;-1!==(t=r.data.indexOf(b,t+1));)n.push({type:7,index:i}),t+=b.length-1}i++}}static createElement(t,e){const s=E.createElement("template");return s.innerHTML=t,s}}function k(t,e,s=t,r){var i,o;if(e===U)return e;let l=void 0!==r?null==(i=s._$Co)?void 0:i[r]:s._$Cl;const n=N(e)?void 0:e._$litDirective$;return(null==l?void 0:l.constructor)!==n&&(null==(o=null==l?void 0:l._$AO)||o.call(l,!1),void 0===n?l=void 0:(l=new n(t),l._$AT(t,s,r)),void 0!==r?(s._$Co??(s._$Co=[]))[r]=l:s._$Cl=l),void 0!==l&&(e=k(t,l._$AS(t,e.values),l,r)),e}class Qe{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,r=((null==t?void 0:t.creationScope)??E).importNode(e,!0);S.currentNode=r;let i=S.nextNode(),o=0,l=0,n=s[0];for(;void 0!==n;){if(o===n.index){let e;2===n.type?e=new j(i,i.nextSibling,this,t):1===n.type?e=new n.ctor(i,n.name,n.strings,this,t):6===n.type&&(e=new tt(i,this,t)),this._$AV.push(e),n=s[++l]}o!==(null==n?void 0:n.index)&&(i=S.nextNode(),o++)}return S.currentNode=E,r}p(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class j{get _$AU(){var t;return(null==(t=this._$AM)?void 0:t._$AU)??this._$Cv}constructor(t,e,s,r){this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=r,this._$Cv=(null==r?void 0:r.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===(null==t?void 0:t.nodeType)&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=k(this,t,e),N(t)?t===p||null==t||""===t?(this._$AH!==p&&this._$AR(),this._$AH=p):t!==this._$AH&&t!==U&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):Ke(t)?this.k(t):this._(t)}S(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.S(t))}_(t){this._$AH!==p&&N(this._$AH)?this._$AA.nextSibling.data=t:this.T(E.createTextNode(t)),this._$AH=t}$(t){var e;const{values:s,_$litType$:r}=t,i="number"==typeof r?this._$AC(t):(void 0===r.el&&(r.el=D.createElement(Ue(r.h,r.h[0]),this.options)),r);if((null==(e=this._$AH)?void 0:e._$AD)===i)this._$AH.p(s);else{const t=new Qe(i,this),e=t.u(this.options);t.p(s),this.T(e),this._$AH=t}}_$AC(t){let e=we.get(t.strings);return void 0===e&&we.set(t.strings,e=new D(t)),e}k(t){Ce(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,r=0;for(const i of t)r===e.length?e.push(s=new j(this.S(M()),this.S(M()),this,this.options)):s=e[r],s._$AI(i),r++;r<e.length&&(this._$AR(s&&s._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){var s;for(null==(s=this._$AP)||s.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cv=t,null==(e=this._$AP)||e.call(this,t))}}class Q{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,r,i){this.type=1,this._$AH=p,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=i,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=p}_$AI(t,e=this,s,r){const i=this.strings;let o=!1;if(void 0===i)t=k(this,t,e,0),o=!N(t)||t!==this._$AH&&t!==U,o&&(this._$AH=t);else{const r=t;let l,n;for(t=i[0],l=0;l<i.length-1;l++)n=k(this,r[s+l],e,l),n===U&&(n=this._$AH[l]),o||(o=!N(n)||n!==this._$AH[l]),n===p?t=p:t!==p&&(t+=(n??"")+i[l+1]),this._$AH[l]=n}o&&!r&&this.j(t)}j(t){t===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Xe extends Q{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===p?void 0:t}}class Ye extends Q{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==p)}}class et extends Q{constructor(t,e,s,r,i){super(t,e,s,r,i),this.type=5}_$AI(t,e=this){if((t=k(this,t,e,0)??p)===U)return;const s=this._$AH,r=t===p&&s!==p||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,i=t!==p&&(s===p||r);r&&this.element.removeEventListener(this.name,this,s),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;"function"==typeof this._$AH?this._$AH.call((null==(e=this.options)?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}}class tt{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){k(this,t)}}const te=H.litHtmlPolyfillSupport;null==te||te(D,j),(H.litHtmlVersions??(H.litHtmlVersions=[])).push("3.1.2");const st=(t,e,s)=>{const r=(null==s?void 0:s.renderBefore)??e;let i=r._$litPart$;if(void 0===i){const t=(null==s?void 0:s.renderBefore)??null;r._$litPart$=i=new j(e.insertBefore(M(),t),t,void 0,s??{})}return i._$AI(t),i};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var ct=Object.defineProperty,ht=Object.getOwnPropertyDescriptor,P=(t,e,s,r)=>{for(var i,o=r>1?void 0:r?ht(e,s):e,l=t.length-1;l>=0;l--)(i=t[l])&&(o=(r?i(e,s,o):i(o))||o);return r&&o&&ct(e,s,o),o},Re=(t=>(t[t.debug=0]="debug",t[t.error=1]="error",t[t.info=2]="info",t[t.success=3]="success",t[t.warning=4]="warning",t))(Re||{});let $=class extends d{constructor(){super(...arguments),this.label="",this.caption="",this.name="",this.required=!1,this.status="",this.type="text"}async connectedCallback(){super.connectedCallback()}firstUpdated(){var t;const e=null==(t=this.renderRoot)?void 0:t.querySelector("slot");let s=null==e?void 0:e.assignedElements();s&&s.forEach((t=>{t.setAttribute("name",this.name),t.setAttribute("title",this.name),t.setAttribute("type",this.type)}))}async disconnectedCallback(){super.disconnectedCallback()}render(){return a`
			...
			${this.caption?a`
				  ...
				  `:p}
		`}setRequiredIcon(){return this.required?a`<ly-icon part="required-icon">asterisk</ly-icon>`:a``}setStatusIcon(){switch(this.status){case"debug":return a`<ly-icon>bug_report</ly-icon>`;case"error":return a`<ly-icon>report</ly-icon>`;case"info":return a`<ly-icon>info</ly-icon>`;case"success":return a`<ly-icon>check</ly-icon>`;case"warning":return a`<ly-icon>emergency_home</ly-icon>`;default:return a``}}};$.styles=at,P([f({type:String,reflect:!0})],$.prototype,"label",2),P([f({type:String,reflect:!0})],$.prototype,"caption",2),P([f({type:String,reflect:!0})],$.prototype,"name",2),P([f({type:Boolean,reflect:!0})],$.prototype,"required",2),P([f({type:Re,reflect:!0})],$.prototype,"status",2),P([f({type:String,reflect:!0})],$.prototype,"type",2),$=P([g("ly-field")],$);const pt=m`
	@layer web-components {
		:host(:is(ly-icon)) {
			/* base styles */
			aspect-ratio: 1/1;
...
`;var dt=Object.defineProperty,ut=Object.getOwnPropertyDescriptor,Te=(t,e,s,r)=>{for(var i,o=r>1?void 0:r?ut(e,s):e,l=t.length-1;l>=0;l--)(i=t[l])&&(o=(r?i(e,s,o):i(o))||o);return r&&o&&dt(e,s,o),o};let G=class extends d{constructor(){super(...arguments),this.solid=!1}render(){return a` <slot></slot> `}};G.styles=pt,Te([f({type:Boolean,reflect:!0})],G.prototype,"solid",2),G=Te([g("ly-icon")],G);var ue=(t=>(t[t.col=0]="col",t[t.row=1]="row",t))(ue||{}),He=(t=>(t[t.picker=0]="picker",t[t.combobox=1]="combobox",t))(He||{}),Me=(t=>(t[t.checkbox=0]="checkbox",t[t.radio=1]="radio",t[t.switch=2]="switch",t))(Me||{});const yt=m`
	@layer web-components {
		:host(:is(ly-check)) {
			/* local vars */
			--gap: var(--scale-5xs);
...
`;var gt=Object.defineProperty,mt=Object.getOwnPropertyDescriptor,C=(t,e,s,r)=>{for(var i,o=r>1?void 0:r?mt(e,s):e,l=t.length-1;l>=0;l--)(i=t[l])&&(o=(r?i(e,s,o):i(o))||o);return r&&o&&gt(e,s,o),o};let w=class extends d{constructor(){super(...arguments),this.checked=!1,this.group="",this.label="",this.variant=""}toggleChecked(){let t;if(this.group){t=document.querySelectorAll(`ly-check[group="${this.group}"]`);for(const e of[...t])e.checked=!1,e.dispatchEvent(new CustomEvent("change",{bubbles:!0,detail:{checked:!1}}))}this.checked=!this.checked,this.dispatchEvent(new CustomEvent("change",{bubbles:!0,detail:{checked:this.checked}}))}async connectedCallback(){super.connectedCallback(),this.setAttribute("tabindex","0"),this.addEventListener("focus",(()=>this.focus())),this.addEventListener("click",(()=>this.toggleChecked()))}async disconnectedCallback(){super.disconnectedCallback(),this.removeAttribute("tabindex"),this.removeEventListener("focus",(()=>this.focus())),this.removeEventListener("click",(()=>this.toggleChecked()))}render(){return a`
		...
		`}handleVariant(){switch(this.variant){case"checkbox":return a`${this.checked?"check_box":"check_box_outline_blank"}`;case"switch":return a`${this.checked?"toggle_on":"toggle_off"}`;case"radio":return a`${this.checked?"check_circle":"radio_button_unchecked"}`;default:return a``}}};w.properties={delegatesFocus:{type:Boolean,reflect:!0}},w.styles=yt,C([f({type:Boolean,reflect:!0})],w.prototype,"checked",2),C([f({type:String,reflect:!0})],w.prototype,"group",2),C([f({type:String,reflect:!0})],w.prototype,"label",2),C([f({type:Me,reflect:!0})],w.prototype,"variant",2),w=C([g("ly-check")],w);let J=class extends d{constructor(){super(...arguments),this.mode="picker"}render(){return a` <slot></slot> `}};J.styles=ft,C([f({type:He,reflect:!0})],J.prototype,"mode",2),J=C([g("ly-select")],J);const vt=m`
	@layer web-components {
		:host(:is(ly-layer)) {
			/* local vars */
			--bg: transparent;
...
`;var $t=Object.defineProperty,_t=Object.getOwnPropertyDescriptor,Ne=(t,e,s,r)=>{for(var i,o=r>1?void 0:r?_t(e,s):e,l=t.length-1;l>=0;l--)(i=t[l])&&(o=(r?i(e,s,o):i(o))||o);return r&&o&&$t(e,s,o),o};let K=class extends d{constructor(){super(...arguments),this.stacked="over"}render(){return a` <slot></slot> `}};K.styles=vt,Ne([f({type:String,reflect:!0})],K.prototype,"stacked",2),K=Ne([g("ly-layer")],K);const bt=m`
	@layer web-components {
		:host(:is(ly-flex)) {
			/* base styles */
			display: flex;
...
`;var Ot=Object.defineProperty,Ut=Object.getOwnPropertyDescriptor,De=(t,e,s,r)=>{for(var i,o=r>1?void 0:r?Ut(e,s):e,l=t.length-1;l>=0;l--)(i=t[l])&&(o=(r?i(e,s,o):i(o))||o);return r&&o&&Ot(e,s,o),o};let Z=class extends d{constructor(){super(...arguments),this.axis="row"}render(){return a` <slot></slot> `}};Z.styles=Ct,De([f({type:ue,reflect:!0})],Z.prototype,"axis",2),Z=De([g("ly-slider")],Z);export{F as App,w as Check,$ as Field,V as Flex,re as Grid,ie as Group,G as Icon,K as Layer,oe as List,ce as ListCell,ae as ListFooter,ne as ListHeader,le as ListRow,J as Select,Z as Slider};