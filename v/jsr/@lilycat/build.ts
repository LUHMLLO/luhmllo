...
let modExports = "// Generated by build.ts\n\n";
...
for await (
  ...
  try {
    ...
    // Add the export to the mod.ts file
    const varName = relativePath.replace(/\//g, "_").replace(/\.css$/, "");
    modExports += `export const ${varName} = \`${result.css}\`;\n`;
